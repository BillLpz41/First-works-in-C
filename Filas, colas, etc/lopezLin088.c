...
int main()
{
	...
	printf("Lista circular dos triple apuntador y dato simple y doble enlace.");
...
void sacarDato(struct nodo ***ptrRef2, struct nodo ***ptrRef1, int dato)
{
	...
	else if(**ptrRef1== **ptrRef2 && (**ptrRef2)->dato== dato)
	{
		ptrBasura= **ptrRef2;
	...
	else
	{
		...
		while(ptr2 != **ptrRef2)
	    {
	    	if((ptrRecorrer->ptrAnt)->dato== dato && ptr2->ptrAnt== **ptrRef2)
	    	{
